...
<body>
    ...
    <div class="row p-3 text-black" style="background-color: rgb(36, 188, 189,0.5);">
        ...
        <nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-light shift p-3">
            <a class="navbar-brand" href="<?= ROOT ?>"><img src="<?= ASSETS . THEME ?>images/DSK_LOGO.png" alt="DSK_LOGO"
                    srcset="" class="img-fluid" style="max-height:10vh;"></a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent"
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item text-end active">
                        <a class="nav-link navbtn" href="<?= ROOT ?>"> Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item text-end">
                        <a class="nav-link navbtn" href="<?= ROOT . "about" ?>"> About</a>
                    </li>
                    <li class="nav-item text-end">
                        <a class="nav-link navbtn" href="<?= ROOT . "product" ?>"> Product</a>
                    </li>
                    <li class="nav-item text-end">
                        <a class="nav-link navbtn" href="<?= ROOT . "enquiry_cart" ?>"> Enquiry Cart</a>
                    </li>
                    <li class="nav-item text-end">
                        <a class="nav-link navbtn" href="<?= ROOT . "contact" ?>"> Contact Us</a>
                    </li>
                </ul>
            </div>
        </nav>
